...
<body>
	  		...
	  		<div class="col-lg-9 rightpanel">
				<div class="card profile" style="width: 100%; margin-bottom: 20px;" >
					<div class="card-header table--card--header">
				    	<span style="font-weight: 500;"> Project Labels</span>
						<span style="float:right">
    						<button id="add_status" class="btn btn-primary btn-sm" onclick="showDiv()"><i class="fas fa-plus"></i>&nbsp;&nbsp;New Project Label</button>
    					</span>
					</div>
							    		...
							    		@foreach ($labels as $labels)
							    			<tr>
								        		...
								        		<td id="categoryEditForm" class="statusEditForm_{{$i}}">
								        			<form action="{{ route('label.update') }}" method="POST" class="categoryEditForm">
				  									@csrf
								        		...
								        		<td class="action--td">	
								        			...
								        			<a href="/setup/project-label-delete-label-{{$labels->id}}" class="dis--remove disabled"><i class="fas fa-times"></i>&nbsp;Remove</a>
								        		</td>
								    		</tr>
								    		<?php $i++; ?>
								    	@endforeach
							    		...
							    		@foreach ($labels as $labels)
								    		<tr>
								        		...
								        		<td class="action--td">	
								        			...
								        			<a href="/setup/project-label-delete-label-{{$labels->id}}"><i class="fas fa-times"></i>&nbsp;Remove</a>
								        		</td>
								    		</tr>
								    	<?php $i++; ?>
								    	@endforeach
							    		...
							    		<form action="{{route('labels.add')}}" method="POST">
							    			...
							    			<tr id="tableformdiv" style="display: none!important;">
								        		...
								        		<td>
								        			...
								        			<a href="/setup/project-label" class="btn btn-sm btn-default">
								        				Cancel
								        			</a>
								        		</td>
								    		</tr>	
  ...
  <script type="text/javascript">
	...
	function sort(id, flag){
		...
		window.open('/setup/project-label','_self');
	}
  </script>
</body>
</html>
