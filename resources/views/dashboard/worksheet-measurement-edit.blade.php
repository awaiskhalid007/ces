...
<body class="takeoffDetailsPage worksheetPage measurements_edit_page">
  ...
  <section id="titles" class="container">
    <div class="inner">
      <a href="/project/{{$project_salt}}/worksheet" class="text-primary">
      ...
      <div class="row">
        <div class="col-lg-6 col-md-6 left">
          ...
          <div class="field-body">
            <a onclick="openRenameMeasurementModel('{{$measurements[0]->id}}', '{{$measurements[0]->description}}')" class="link-with-hover-icon" style="cursor: pointer;"><div class="form-control-static">{{$measurements[0]->description}}<i class="far fa-edit margin-left-sm"></i></div></a>
          </div>
        </div>
  ...
  <div class="modal-dialog modal-dialog-centered" role="document" style="max-width: 700px!important;min-width: 700px!important;">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLongTitle">Adjust</h5>
