               ...
               <div class="col-md-6">
                ...
                <hr>
                  <div class="container py-2" style="border: 1px solid #E5E5E5; border-radius: 5px;"> 
                      <strong>{{$user[0]->name}}</strong> <span class="badge badge-warning" style="color: white;">Owner</span> <span class="badge badge-success">You</span>
