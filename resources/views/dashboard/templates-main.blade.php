        ...
        <div class="row">
          ...
          <div class="col-lg-9">
            <nav class="navbar navbar-expand-lg navbar-light bg-default myprojects--nav">
              <a class="navbar-brand nav--main--item">Projects Templates</a>
            ...
            <table class="table" style="margin-top:10px;">
              @if(!$templates->isEmpty() || $shared_templates != '')
                @if($shared_templates != '')
                  @foreach($shared_templates as $template)
                    <tr>
                      <td><a style="text-decoration: none;color: #999;">{{$template->name}}</a></td>
                      <td>
                        <div class="projects-list-right">
                          <div class="projects-listmenu-wrap">
                            <div class="dropdown">
                                <a class="dropdown-toggl js-toggle-project-menu text-dark" data-toggle="dropdown"><i class="far fa-play-circle fa-rotate-90" style="color: #999;"></i></a>
              ...
              @foreach($templates as $template)
                <tr>
                  <td><a href="project/template/{{$template->salt}}/tasks" style="text-decoration: none;">{{$template->name}}&nbsp;&nbsp;<i class="fas fa-edit"></i></a></td>
                  <td>
                    <div class="projects-list-right">
                      <div class="projects-listmenu-wrap">
                        <div class="dropdown">
                            <a  class="dropdown-toggl js-toggle-project-menu text-dark" data-toggle="dropdown"><i class="far fa-play-circle fa-rotate-90"></i></a>
                            <ul class="dropdown-menu pull-right" role="menu">
                              <li class="disabled"><a>Template Actions</a></li>
                              <li class="divider"></li>
                              <li>
                                <form action="{{route('template.duplicate')}}" method="POST">
                                  @csrf
                              ...
                              <li class="divider"></li>
                              <li>
                                <a class="btn btn-muted" href="project-templates/open/{{$template->id}}/delete"><i class="fa fa-trash-alt"></i> Delete</a>
              ...
              @else
                <div class="text-center" style="padding-top: 20px;">
                  ...
                  <button data-toggle="modal" data-target="#add_template_modal" class="btn btn-primary btn-lg" style="margin-top: 20px; margin-bottom: 20px;">Create Template</button><br>
                </div>
              @endif
            </table>
          </div>
