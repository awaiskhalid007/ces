        ...
        <div class="row">
          ...
          <div class="col-lg-9">
            <nav class="navbar navbar-expand-lg navbar-light bg-default myprojects--nav">
              <a class="navbar-brand nav--main--item" href="javascript::void(0)">Take Off Templates</a>
            ...
            <br>
            <div class="row">
              <div class="left" style="width: 100%; padding-left:20px;"><b>Name</b></div>
              {{-- <div class="right"><b>Label</b></div> --}}
            </div>
                      ...
                      <div class="projects-listmenu-wrap">
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu pull-right" role="menu">
                              ...
                              <li class="divider"></li>
                              <li>
                                <a href="#" data-action="duplicate-project" data-projectid="pyCaPqYPdHJcyn5JW"><i class="far fa-copy"></i> Rename</a>
                              </li>
                              <li>
                              ...
                              <li class="divider"></li>
                              <li>
                                <a class="btn btn-muted" href="takeoff-templates/open/{{$template->id}}/undo"><i class="fas fa-undo-alt"></i> Restore</a>
