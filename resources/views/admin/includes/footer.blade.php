<footer class="footer text-center">
                All Rights Reserved by GroundPlan. Designed and Developed by <a href="https://lenticas.com">Lenticas</a>.
            </footer>
            <!-- ============================================================== -->
            <!-- End footer -->
            <!-- ============================================================== -->
...
<!-- All Jquery -->
    ...
    <script src="{{ asset('admin/assets/libs/gaugeJS/dist/gauge.min.js')}}"></script>
    <script src="{{ asset('admin/assets/libs/flot/excanvas.min.js')}}"></script>
