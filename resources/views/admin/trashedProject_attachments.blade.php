                        ...
                        <div class="card bg-light">
                            <div class="card-body">
                                <div class="d-flex no-block align-items-center m-b-10">
                                    <h4 class="card-title">Trashed Project Attachments</h4>
                                </div>
                                        ...
                                        <tbody>
                                            ...
                                            @foreach ($data as $attach)
                                                <tr>
                                                    <td>{{$i++}}</td>
                                                    <td>
                                                        <img src="../../../img/attachments/{{$attach->file}}" style="width: 50px; margin-right: 10px;" alt="not found">
                                                        {{$attach->name}}
                                                    </td>
                                                    <td>
                                                        @php
                                                            echo date('d M, Y', strtotime($attach->created_at));
                                                        @endphp
                                                    </td>
                                                     <td>
                                                       <a href="{{ route('trashedProjectAttachment.del',$attach->id)}}"><i class="far fa-trash-alt mx-3"></i></a>
                                                    </td>
                                                </tr>
                                            @endforeach
                                        </tbody>
