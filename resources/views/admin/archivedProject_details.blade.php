            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-5 align-self-center">
                        <h4 class="page-title">Archived Project Details</h4>
                    ...
                    <div class="col-12">
                       <div class="container">
                        ...
                        <div class="row">
                           ...
                           <div class="col-md-6">
                               <strong style="font-size: 18px;">Status:</strong><br>
                                @if(empty($data['status'])) 
                                        <p>Not Available</p>
                                    @else
                                       <span class="label" style="background-color:{{$data['color']}}">{{$data['status']}}</span>
                                   @endif
                           </div>
                        </div>
                         <div class="row">
                         ...
                         <div class="row">
                          <div class="col-md-6">
                               <strong style="font-size: 18px;">Archived Reason:</strong>
                               <br>
                               <span class="label" style="background-color:{{$data['reason_color']}}">{{$data['reason']}}</span>
                           </div>
                           <div class="col-md-6">
