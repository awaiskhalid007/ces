                        ...
                        <div class="card bg-light">
                            <div class="card-body">
                                <div class="d-flex no-block align-items-center m-b-10">
                                    <h4 class="card-title">User Project Labels</h4>
                                </div>
                                        ...
                                        <tbody>
                                            @forelse($data as $data)
                                                <tr>
                                                    ...
                                                    <td>
                                                       <a href="{{ route('userProjectLabel.del',$data->id)}}"><i class="far fa-trash-alt mx-3"></i></a>
                                                    </td>
                                                </tr>
                                            @empty
                                                <td colspan="3" style="text-align: center;">No Labels Records</td>
                                            @endforelse
                                        </tbody>
                                    </table>
                                </div>
